...
ImgWarper.Warper = function(
    canvas, img, optGridSize, optAlpha) {
  ...
  this.ctx.drawImage(source, 0, 0, canvas.width, canvas.height);

  this.imgData = this.ctx.getImageData(0, 0, canvas.width, canvas.height).data;
